...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {fpin}];  # "JA1"
#set_property PACKAGE_PIN AA11 [get_ports {JA2}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {bpin}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {ppin}];  # "JA4"
#set_property PACKAGE_PIN AB11 [get_ports {ppin}];  # "JA7"
...
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {btn_flip_led}];  # "JB1"
set_property PACKAGE_PIN W11 [get_ports {btn_plm_skip_led}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {bpin_led}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports {ppin_led}];  # "JB4"
...
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN AB6 [get_ports {fpout}];  # "JC1_N"
#set_property PACKAGE_PIN AB7 [get_ports {fpout_nn}];  # "JC1_P"
set_property PACKAGE_PIN AA4 [get_ports {fpout}];  # "JC2_N"
...
# JD Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN W7 [get_ports {fpout_nn}];  # "JD1_N"
#set_property PACKAGE_PIN V7 [get_ports {fpout_nn}];  # "JD1_P"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {fpin_led}];  # "LD0"   DLP Frame Input
set_property PACKAGE_PIN T21 [get_ports {fpout_nn}];  # "LD1"   Output logic
set_property PACKAGE_PIN U22 [get_ports {reset_led}];  # "LD2"  Reset
set_property PACKAGE_PIN U21 [get_ports {user_led}];  # "LD3"   User Input
set_property PACKAGE_PIN V22 [get_ports {states[0]}];  # "LD4"  States
set_property PACKAGE_PIN W22 [get_ports {states[1]}];  # "LD5"  *
set_property PACKAGE_PIN U19 [get_ports {states[2]}];  # "LD6"  *
set_property PACKAGE_PIN U14 [get_ports {states[3]}];  # "LD7"  *
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {btn_fpin}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {btn_flip}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {btn_bpin}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {btn_user}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {btn_com}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {btn_ppin}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {btn_plm_skip}];  # "SW6"
#set_property PACKAGE_PIN M15 [get_ports {btn_ppin_hld}];  # "SW7"
